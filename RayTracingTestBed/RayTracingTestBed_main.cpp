...
// Test Engine
#include "../deps/imgui_test_engine/imgui_test_engine/imgui_te_engine.h"
#include "../deps/imgui_test_engine/imgui_test_engine/imgui_te_ui.h"
#include "../deps/imgui_test_engine/imgui_test_engine/imgui_te_utils.h"   // ImOsIsDebuggerPresent()
...
int main(int argc, char** argv)
{
    ...
    app->InitCreateWindow(app, "The Ray Tracer Challenge", ImVec2(1600, 1000));
